...
- Using the new C++17 [\<charconv\>](https://abseil.io/about/design/charconv) library for incredibly fast floating point encoding/decoding
...
- `"100000000000000000000"` will be stores as a `double` as it is too large for `uint64_t`
